...
addfunc		cpu			do_ps
// walltimemark/walltime: high-resolution wall-clock step timer (added
// GENESIS 2.5, 2026-07-25; see sim_ops.c for rationale). Correct for both
// CPU and GPU-accelerated arms, unlike "cpu" (void/getrusage-based).
addfunc		walltimemark		do_walltimemark
addfunc		walltime		do_walltime		float
