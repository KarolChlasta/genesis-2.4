...
/* hsolve_type.156: anonymous/opaque field, skipped (sizeof(#) invalid on modern gcc) */
if (strlen(fields) > 2500) { Error(); printf("Field size too long for object hsolve_type, field 156\n**See sys/code_sym.c and increase the value of MAX_FIELDS_SIZE\n\n"); }
/* hsolve_type.165: anonymous/opaque field, skipped (sizeof(#) invalid on modern gcc) */
if (strlen(fields) > 2500) { Error(); printf("Field size too long for object hsolve_type, field 165\n**See sys/code_sym.c and increase the value of MAX_FIELDS_SIZE\n\n"); }
...
/* hsolve_type.188: anonymous/opaque field, skipped (sizeof(#) invalid on modern gcc) */
if (strlen(fields) > 2500) { Error(); printf("Field size too long for object hsolve_type, field 188\n**See sys/code_sym.c and increase the value of MAX_FIELDS_SIZE\n\n"); }
