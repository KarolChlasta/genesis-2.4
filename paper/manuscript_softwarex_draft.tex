...
A broken $O(N)$ scheduler loop, re-scheduling neurons $2\ldots N$ on every step, is fixed; that repair is what makes Section~3's throughput attainable at all.
