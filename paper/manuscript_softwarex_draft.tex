...
\hline
C2 & Permanent GitHub link to code/repository used for this code version & \url{https://github.com/WarsawIQ/genesis-2.5} (archived release: Zenodo DOI \emph{to be inserted upon release}) \\
\hline
...
Full replication steps and raw data are in \path{paper/REPLICATION.md} and the self-contained \path{experiments/} package.
