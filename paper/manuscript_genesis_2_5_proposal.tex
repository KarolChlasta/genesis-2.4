...
did not perturb \texttt{Vm} even on the CPU-only path, so this does not yet exercise
spiking dynamics or bound fp32 rounding error during real channel-gating transients. This
remains open work.
